...
// The Leros ALU including the accumulator register. `op` selects the operation
// (nop/add/sub/and/or/xor/ld/shr); one operand is the accumulator, the other is
// `din`. The enaMask/enaByte/enaHalf/off inputs support the byte/half-word and
// load-high instructions by writing only selected bytes of the accumulator.
