...
// RISC-V ISA constants and enumerations, shared between the hardware and a
// Scala instruction-set simulator. Defined as Scala values so both can use them
// (the hardware converts them with .U / .id.U).
